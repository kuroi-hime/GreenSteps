<x-dashbord-layout>
  ...
  <div class="flex flex-col gap-5">
    ...
    <div class="flex justify-between items-center">
      ...
      <!-- Add Button -->
      <a href="{{route('client.plantes.create')}}" id="add-plant-btn" class="bg-green-500 text-white px-4 py-2 rounded flex items-center">
      ...
      <table class="w-full border bg-white text-center table-fixed">
        ...
        <tbody class="text-sm">
          ...
          <tr class="hover:bg-gray-100">
            ...
            <td class="">
                <a href="{{ route('admin.plantes.edit', $plante) }}" class="text-yellow-500">
                    <span class="material-symbols-outlined">edit</span>
                </a>
                <form action="{{route('admin.plantes.destroy', $plante)}}" method="post"
                      onsubmit="confirm('{{__('Do you realy want to delete this plant : :name ?', ['name' => $plante->nom_commun])}}')">
                  @method('delete')
  ...
  <div id="plant-form" class="flex justify-center z-[99] fixed inset-0 py-2 max-h-screen w-full bg-black/50 hidden">
    <form method="post" action="{{route('test')}}" id="add-plant-form" class="bg-white rounded shadow flex flex-col justify-center">
      @csrf
      <div class="bg-[#F8FAFC]/50 px-5 py-3 flex justify-between items-center">
        <h2 class="font-semibold">Add New Plant</h2>
        <svg class="btn-form-close h-8 w-8 text-[#94A3B8]" viewBox="0 0 76 76" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" baseProfile="full" enable-background="new 0 0 76.00 76.00" xml:space="preserve" fill="currentColor"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill="currentColor" fill-opacity="1" stroke-width="0.2" stroke-linejoin="round" d="M 26.9166,22.1667L 37.9999,33.25L 49.0832,22.1668L 53.8332,26.9168L 42.7499,38L 53.8332,49.0834L 49.0833,53.8334L 37.9999,42.75L 26.9166,53.8334L 22.1666,49.0833L 33.25,38L 22.1667,26.9167L 26.9166,22.1667 Z "></path> </g></svg>
      </div>
      ...
      <div class="flex flex-col gap-7 p-5 flex-1 overflow-y-auto">
        ...
        <div class="flex flex-col gap-4">
          ...
          <div>
            ...
            <div>
              ...
              <input type="text" name="nom_commun" placeholder="e.g Tomato" class="w-full border p-2 mb-3">
            ...
            <div>
              ...
              <input type="text" name="nom_scientifique" placeholder="e.g. Solanum lycopersicum" class="w-full border p-2 mb-3">
            ...
            <div class="flex gap-3">
              ...
              <div class="w-full flex flex-col gap-1">
                ...
                <select class="w-full border p-2 mb-3" name="categorie_id">
              ...
              <div class="w-full flex flex-col gap-1">
                ...
                <select class="w-full border p-2 mb-3" name="difficulte_plante">
        ...
        <div class="flex flex-col gap-4">
          <h2 class="flex gap-2 items-center text-[#17CF5A]">
            <svg class="h-5 w-5" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <rect width="48" height="48" fill="white" fill-opacity="0.01"></rect> <path d="M41.5 10H35.5" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M27.5 6V14" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M27.5 10L5.5 10" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M13.5 24H5.5" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M21.5 20V28" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M43.5 24H21.5" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M41.5 38H35.5" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M27.5 34V42" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M27.5 38H5.5" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
            <span>Care Requirements</span>
          </h2>
          <div class="flex gap-3">
            <!-- Sunlight -->
            <div class="w-full flex flex-col gap-2 p-[0.75rem] bg-[#F8FAFC] rounded-[8px]">
              <label for="" class="flex gap-2 items-center">
                <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M7.5 2.25V0H9V2.25H7.5ZM7.5 16.5V14.25H9V16.5H7.5ZM14.25 9V7.5H16.5V9H14.25ZM0 9V7.5H2.25V9H0ZM13.275 4.275L12.225 3.225L13.5375 1.875L14.625 2.9625L13.275 4.275ZM2.9625 14.625L1.875 13.5375L3.225 12.225L4.275 13.275L2.9625 14.625ZM13.5375 14.625L12.225 13.275L13.275 12.225L14.625 13.5375L13.5375 14.625ZM3.225 4.275L1.875 2.9625L2.9625 1.875L4.275 3.225L3.225 4.275ZM8.25 12.75C7 12.75 5.9375 12.3125 5.0625 11.4375C4.1875 10.5625 3.75 9.5 3.75 8.25C3.75 7 4.1875 5.9375 5.0625 5.0625C5.9375 4.1875 7 3.75 8.25 3.75C9.5 3.75 10.5625 4.1875 11.4375 5.0625C12.3125 5.9375 12.75 7 12.75 8.25C12.75 9.5 12.3125 10.5625 11.4375 11.4375C10.5625 12.3125 9.5 12.75 8.25 12.75ZM8.25 11.25C9.0875 11.25 9.79688 10.9594 10.3781 10.3781C10.9594 9.79688 11.25 9.0875 11.25 8.25C11.25 7.4125 10.9594 6.70312 10.3781 6.12187C9.79688 5.54062 9.0875 5.25 8.25 5.25C7.4125 5.25 6.70312 5.54062 6.12187 6.12187C5.54062 6.70312 5.25 7.4125 5.25 8.25C5.25 9.0875 5.54062 9.79688 6.12187 10.3781C6.70312 10.9594 7.4125 11.25 8.25 11.25Z" fill="#EAB308"/>
                </svg>
                <span>Sunlight</span>
              </label>
              <select class="w-full border p-2 mb-1 rounded-[4px]" name="sunlight_plante">
          ...
          <div class="flex gap-3">
            ...
            <div class="w-full flex flex-col gap-2 p-[0.75rem] bg-[#F8FAFC] rounded-[8px]">
              ...
              <input type="number" name="min_temp_plante" id="" placeholder="Temperature in C°" min=0 step="0.01" class="w-full border p-2 mb-3 rounded-[4px]">
            ...
            <div class="w-full flex flex-col gap-2 p-[0.75rem] bg-[#F8FAFC] rounded-[8px]">
              ...
              <input type="number" name="max_temp_plante" id="" placeholder="Temperature in C°" min=0 step="0.01" class="w-full border p-2 mb-3 rounded-[4px]">
          ...
          <div class="flex gap-3">
            ...
            <div class="w-full flex flex-col gap-2 p-[0.75rem] bg-[#F8FAFC] rounded-[8px]">
              ...
              <input type="number" name="height_plante" min=0 step="0.01" placeholder="The height in cm" class="w-full border p-2 mb-3 rounded-[4px]">
            ...
            <div class="w-full flex flex-col gap-2 p-[0.75rem] bg-[#F8FAFC] rounded-[8px]">
              ...
              <input type="number" name="days_to_recolt" min=1 placeholder="Days to recolt" class="w-full border p-2 mb-3 rounded-[4px]">
              <x-input-error :messages="$errors->get('days_to_recolt')" class="mt-1" />
            </div>
          </div>
        </div>
        ...
        <div class="flex flex-col gap-4">
            ...
            <input type="text" id="img-input" class="cursor-pointer w-full border p-2 mb-1 rounded-[4px]" placeholder="Image's URL"/>
            <x-input-error :messages="$errors->get('images')" class="mt-1" />
            <div id="img-preview" class="grid grid-cols-5 gap-3">
            </div>
        </div>
      ...
      <!-- Action Button -->
      <div class="p-6 flex gap-3 justify-center bg-[#F8FAFC] border-t border-[#E2E8F0]">
        <!-- Cancel button -->
  ...
  <script>
    const plant_form_conatiner = document.getElementById('plant-form')
    const btn_add_plant = document.getElementById('add-plant-btn')
    btn_add_plant.addEventListener('click', ()=>{
        plant_form_conatiner.classList.remove('hidden')
    })

    const btns_form_close = document.querySelectorAll('.btn-form-close')

    btns_form_close.forEach(btn => {
      btn.addEventListener('click', ()=>{
        plant_form_conatiner.classList.add('hidden')
      })
    });

    const btn_save_plant = document.getElementById('save-plant')
    const img_input = document.getElementById('img-input')
    const img_preview = document.getElementById('img-preview')
    const img_urls = []
    const add_plant_form = document.getElementById('add-plant-form')
    let img_cmp = 0

    img_input.addEventListener('input', ()=>{
      const img_file = img_input.value
      if(img_preview.children.length == 5)
      {
        img_input.value = ''
        alert("{{__('Only 5 images allowed')}}")
        return;
      }
      if(img_file && !img_urls.includes(img_file))
      {
        img_urls[img_cmp] = img_file
        const div = document.createElement('div')
        div.className = "relative aspect-square bg-slate-100 rounded-lg border border-slate-200 overflow-hidden group max-h-20"
        div.id = `img-${img_cmp++}`
        div.innerHTML = `
          <img src="${img_file}" class="object-cover w-full h-full">
          <button type="button" onclick="deletePlant('${div.id}', '${img_file}')" class="absolute top-1 right-1 bg-red-500 text-white rounded-full p-0.5 shadow-md opacity-0 group-hover:opacity-100 transition-opacity">
    ...
    function deletePlant(id, url){
      const element = document.getElementById(id);
      if (element) {
        element.remove()
        const element_index = img_urls.indexOf(url)
        if(element_index > -1)
          img_urls.splice(element_index, 1) //where, how many to remove
      }
    }
    
    btn_save_plant.addEventListener('click', ()=>{
      ...
      img_urls.forEach(url=>{
        ...
        hidden_input.name = "images[]"
        hidden_input.value = url
        img_preview.appendChild(hidden_input)
      })
      add_plant_form.submit();
    })
  </script>
</x-dashbord-layout>